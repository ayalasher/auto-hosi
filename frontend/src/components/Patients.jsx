  ...
  return (
    <div className={styles.patientssection}  >
      <div className={styles.ptopsetion} >
        ...
        {/* <div className={styles.ptxtdiv2} >  <button className={styles.loginsignupbutton} >Search</button> </div> */}
        ...
        <div>
...

          {
            ...
            /> : patientsdatafromredux.map((item) => <div className={styles.itemsdiv} >
              {/* <ol> */}
              <Link to={"/Home/patient"} title={item.fields.last_name} className={styles.innerrows} >

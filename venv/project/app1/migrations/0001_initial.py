    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('doctor', 'Doctor'), ('nurse', 'Nurse'), ('receptionist', 'Receptionist'), ('lab_technician', 'Lab Technician')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_details', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.patientdata')),
            ],
        ),
        migrations.CreateModel(
            name='Diagnosis',
